...
START:
    ...
    MOV CX, COUNT        ; Load the count of numbers to print
    MOV SI, OFFSET LIST  ; SI points to the start of LIST
PRINT_LOOP:
    MOV AX, [SI]        ; Load number into AX
    CALL PRINT_NUM       ; Print the number
    ADD SI, 2           ; Move to the next number in the list
    LOOP PRINT_LOOP      ; Repeat for all numbers
...
.CONVERT_LOOP:
    ...
    TEST AX, AX          ; Check if AX is 0 (fix this line)
    JNZ .CONVERT_LOOP    ; Loop until AX is 0
